...
function superfluid_stiffness_finiteT(m::ModelParams; T::Real, niter::Int=100, tol::Real=1e-12, Δ_init=nothing, scratchpath=nothing, symmetry::String="d-wave")

    U, V, E, Δ = BdG_coefficients(m, T=T, niter=niter, tol=tol, Δ_init=Δ_init, scratchpath=scratchpath, symmetry=symmetry)

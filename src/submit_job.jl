...
function submit_job(params::ModelParams, filepath, dirpath, job_prefix; nodes=1, ntasks=1, cpus_per_task=8, mem=256, partition="owners,simes", kwargs="", time="24:00:00")
    ...
    # run the script
    julia $filepath $(params.L) $(params.t) $(params.Q) $(params.μ) $(params.θ) $(params.ϕx) $(params.ϕy) $(params.ϕz) $(params.V0) $(params.V1) $(params.J) $(params.periodic) $(params.ndims) $(Int(params.disorder)) $kwargs"""
